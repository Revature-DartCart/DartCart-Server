...
public class InvoiceControllerTest {
    ...
    void getAllInvoicesBySellerId_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/invoices/seller/1")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    void getAllInvoicesByShopId_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/invoices/shop/1")).andExpect(MockMvcResultMatchers.status().isOk());
    }
}
