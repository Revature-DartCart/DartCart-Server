...
class UserControllerTest {
    ...
    public void testUserCheckoutWithValidCart() throws Exception {
        ...
        user.getItemList().add(new CartItem(1, 3, false, user, new ShopProduct(1, 5, 100, 100, null, null)));
        ...
        mvc
            ...
            .andExpectAll(MockMvcResultMatchers.status().isOk(), MockMvcResultMatchers.jsonPath("$.id").value(1));
    }
    ...
    public void testUserWithInvalidQuantity() throws Exception {
        ...
        mvc
            ...
            .andExpectAll(MockMvcResultMatchers.status().isNotAcceptable());
    }
}
